    ...
    <?php foreach ($trips as $trip): ?>
        <div class="trip-container">
           ...
           <button class="details-btn"
            ...
            data-city="<?= htmlspecialchars($trip['city']) ?>"
            data-country="<?= htmlspecialchars($trip['country']) ?>"
            data-departure="<?= date('Y. m. d.', strtotime($trip['departure'])) ?>"
            data-arrival="<?= date('Y. m. d.', strtotime($trip['arrival'])) ?>"
            data-spots="<?= htmlspecialchars($trip['available_spots'] ?? '–') ?>"
            data-price="<?= htmlspecialchars($trip['price_per_night'] ?? '–') ?>"
            data-image="/uploads/<?= htmlspecialchars($trip['image_url']) ?>"
            data-description="<?= htmlspecialchars($trip['full_description'] ?? 'Leírás nem elérhető.', ENT_QUOTES) ?>">
            Részletek
            </button>
